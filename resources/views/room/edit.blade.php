            ...
            <div>
                ...
                <div class="m-auto mt-4 flex w-[60%] flex-col gap-2 rounded-md bg-white px-12 py-8 shadow-md" x-data>
                    ...
                    <div>
                        ...
                        <x-input-text id="name" name="name" placeholder="Phòng 302" :value="$room->name">
                        </x-input-text>
                    ...
                    <div>
                        ...
                        <x-input-text id="quantity" name="quantity" type="number" min="1" max="99"
                            :value="$room->quantity" placeholder="1"></x-input-text>
                    ...
                    <div>
                        ...
                        <x-input-text id="price" name="price" x-mask:dynamic="$money($input, ',')"
                            :value="$room->price_text" placeholder="1.000.000"></x-input-text>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            id="description" name="description" placeholder="Phòng sạch sẽ rộng rãi">{{ $room->description }}</textarea>
                        <x-input-error :messages="$errors->get('description')"></x-input-error>
                    </div>
                    <div class="flex items-center justify-end">
                        <button class="bg-dark-blue h-fit w-fit rounded-md px-2 py-2 text-white" type="submit">Lưu thay
                            đổi</button>
                    </div>
                </div>

                <!-- Image -->
                <div class="mt-4" x-data="multiImgPreview">
                    <label
                            ...
                            <div
                                ...
                                @foreach ($room->images as $image)
                                    <div class="my-1 w-1/5 px-1">
                                        <img class="rounded-md" src="{{ Vite::asset('storage/app/' . $image->src) }}"
                                            alt="image" x-bind:class="src != null && 'hidden'">
                                    </div>
                                @endforeach
                            </div>
                        @endif
